...
const EXTRAS: { icon: React.ElementType; title: string; body: React.ReactNode }[] = [
  ...
  { icon: Compass, title: 'Runs on autopilot', body: <>Prices, exchange rates, recurring salary/bills, CPF, and your net-worth snapshot all update on a daily schedule server-side — so your numbers stay current even on days you don&apos;t open the app.</> },
