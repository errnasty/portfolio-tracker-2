...
const EXTRAS: { icon: React.ElementType; title: string; body: React.ReactNode }[] = [
  ...
  { icon: Landmark, title: 'Tax estimator (Singapore)', body: <>Use <TLink href="/tax" className="text-accent hover:underline">Plan → Tax</TLink> to estimate your income tax on YA2024+ resident rates, see your effective and marginal rate, and model how much an SRS or CPF cash top-up would shave off this year&apos;s bill.</> },
