...
const EXTRAS: { icon: React.ElementType; title: string; body: React.ReactNode }[] = [
  ...
  { icon: Vault, title: 'Funds not on Yahoo Finance', body: <>Adding a holding, switch to <strong className="text-foreground">Manual / unlisted fund</strong> for anything Yahoo doesn&apos;t quote — Singapore unit trusts, for example. Point it at Lion Global Investors&apos; fund code and the NAV refreshes itself daily; otherwise update the price by hand whenever the fund publishes one.</> },
]
